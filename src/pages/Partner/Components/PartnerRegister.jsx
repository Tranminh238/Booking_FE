...
const PartnerRegister = () => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 pt-16 pb-12 overflow-y-auto">
            <div className="max-w-md w-full mx-4 my-auto relative">
                <div className="bg-white rounded-lg shadow-2xl p-8 space-y-8 relative">
                        ...
                        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
                            ...
                            <div className="mt-4 text-center">
                                <p className="text-sm text-gray-600">
                                    Đã có tài khoản?{" "}
                                    <Link to="/login-partner" className="text-indigo-600 hover:underline">
                                        Đăng nhập ngay
                                    </Link>
                                </p>
                            </div>
